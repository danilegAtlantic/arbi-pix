...
import { AlterarEnderecamentoDTO } from './AlterarEnderecamentoDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class AlterarEnderecamentoUseCase {
    private readonly url: string = 'https://gaph.bancoarbi.com.br/pix/v2/enderecamento/alterar/campoExtra';

    constructor(
        /* private solicitacaoRepository: ISolicitacaoRepository, */
    ) { };

    async run(data: AlterarEnderecamentoDTO) {
        ...
        const config: AxiosRequestConfig = {
            method: 'put',  // Use 'post' como valor para o tipo Method
