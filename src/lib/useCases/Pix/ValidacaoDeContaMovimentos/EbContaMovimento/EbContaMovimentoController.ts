...
import SolicitacaoValidationRules from './EbContaMovimentoValidationRules.json';
import { EbContaMovimentoUseCase } from "./EbContaMovimentoUseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class EbContaMovimentoController {

    constructor(private SolicitacaoUseCase: EbContaMovimentoUseCase) { };
