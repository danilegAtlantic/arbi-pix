...
import { ParticipantePixDTO } from './ParticipantePixDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class ParticipantePixUseCase {
    ...
    async run(Data: ParticipantePixDTO) {
        const axios = require('axios');

        let config = {
            method: 'get',
            maxBodyLength: Infinity,
            url: 'https://gaph.bancoarbi.com.br/pix/v2/operacao/participante_pix',
            headers: {
