...
import OperacaoListaPgtosAgendadosValidationRules from './ParticipantePixValidationRules.json';
import {ParticipantePixUseCase } from "./ParticipantePixUseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class ParticipantePixController {

    constructor(private SolicitacaoUseCase: ParticipantePixUseCase) { };
