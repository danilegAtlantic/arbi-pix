...
import { OperacaoTratamentoFalhaDebitoDTO } from './OperacaoTratamentoFalhaDebitoDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class OperacaoTratamentoFalhaDebitoUseCase {
    ...
    async run(Data: OperacaoTratamentoFalhaDebitoDTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/operacao/tratamento/falha_debito',
            headers: {
