...
import OperacaoListaPgtosAgendadosValidationRules from './OperacaoTratamentoFalhaDebitoValidationRules.json';
import {OperacaoTratamentoFalhaDebitoUseCase } from "./OperacaoTratamentoFalhaDebitoUseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class OperacaoTratamentoFalhaDebitoController {

    constructor(private SolicitacaoUseCase: OperacaoTratamentoFalhaDebitoUseCase) { };
