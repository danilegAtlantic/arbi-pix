...
import {OperacaoGerarReturnIdUseCase } from "./OperacaoGerarReturnIdUseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class OperacaoGerarReturnIdController {

    constructor(private SolicitacaoUseCase: OperacaoGerarReturnIdUseCase) { };
