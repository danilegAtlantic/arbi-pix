...
import { OperacaoGerarReturnIdDTO } from './OperacaoGerarReturnIdDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class OperacaoGerarReturnIdUseCase {
    ...
    async run(Data: OperacaoGerarReturnIdDTO) {
        const axios = require('axios');

        let config = {
            method: 'post',
            maxBodyLength: Infinity,
            url: 'https://gaph.bancoarbi.com.br/pix/v2/operacao/gerar_return_id/{codIspb}',
            headers: {
