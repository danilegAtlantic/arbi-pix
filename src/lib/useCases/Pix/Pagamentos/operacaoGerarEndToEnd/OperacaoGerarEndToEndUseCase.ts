...
import { OperacaoGerarEndToEndDTO } from './OperacaoGerarEndToEndDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class OperacaoGerarEndToEndUseCase {
    ...
    async run(Data: OperacaoGerarEndToEndDTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/operacao/gerar_end_to_end/{codIspb}',
            headers: {
