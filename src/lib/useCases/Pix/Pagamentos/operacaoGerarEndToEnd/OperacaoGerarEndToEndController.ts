...
import OperacaoCancelaPgtoValidationRules from './OperacaoGerarEndToEndValidationRules.json';
import {OperacaoGerarEndToEndUseCase } from "./OperacaoGerarEndToEndUseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class OperacaoExtratoPixV2Controller {

    constructor(private SolicitacaoUseCase: OperacaoGerarEndToEndUseCase) { };
