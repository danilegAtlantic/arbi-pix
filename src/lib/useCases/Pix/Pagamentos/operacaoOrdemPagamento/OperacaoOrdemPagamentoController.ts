...
import OperacaoListaPgtosAgendadosValidationRules from './OperacaoOrdemPagamentoValidationRules.json';
import {OperacaoOrdemPagamentoUseCase } from "./OperacaoOrdemPagamentoUseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class OperacaoOrdemPagamentoController {

    constructor(private SolicitacaoUseCase: OperacaoOrdemPagamentoUseCase) { };
