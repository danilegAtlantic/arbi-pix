...
import OperacaoListaPgtosAgendadosValidationRules from './OperacaoOrdemPagamentoEndToEndValidationRules.json';
import {OperacaoOrdemPagamentoEndToEndUseCase } from "./OperacaoOrdemPagamentoEndToEndUseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class OperacaoOrdemPagamentoEndToEndController {

    constructor(private SolicitacaoUseCase: OperacaoOrdemPagamentoEndToEndUseCase) { };
