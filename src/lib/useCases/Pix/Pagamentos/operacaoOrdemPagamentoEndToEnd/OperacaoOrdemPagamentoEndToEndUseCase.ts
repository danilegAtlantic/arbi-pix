...
import { OperacaoOrdemPagamentoEndToEndDTO } from './OperacaoOrdemPagamentoEndToEndDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class OperacaoOrdemPagamentoEndToEndUseCase {
    ...
    async run(Data: OperacaoOrdemPagamentoEndToEndDTO) {
        const axios = require('axios');

        let config = {
          method: 'get',
          maxBodyLength: Infinity,
          url: 'https://gaph.bancoarbi.com.br/pix/v2/operacao/ordem_pagamento/end_to_end{endToEnd}',
          headers: { 
