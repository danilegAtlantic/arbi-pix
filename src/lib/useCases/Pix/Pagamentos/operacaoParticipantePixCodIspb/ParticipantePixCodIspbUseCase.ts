...
import { ParticipantePixCodIspbDTO } from './ParticipantePixCodIspbDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class ParticipantePixCodIspbUseCase {
    ...
    async run(Data: ParticipantePixCodIspbDTO) {
        const axios = require('axios');

        let config = {
            method: 'get',
            maxBodyLength: Infinity,
            url: 'https://gaph.bancoarbi.com.br/pix/v2/operacao/participante_pix/{codIspb}',
            headers: {
