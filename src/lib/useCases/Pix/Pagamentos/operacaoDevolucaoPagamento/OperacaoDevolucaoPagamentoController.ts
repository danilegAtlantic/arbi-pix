...
import OperacaoCancelaPgtoValidationRules from './OperacaoDevolucaoPagamentoValidationRules.json';
import { OperacaoDevolucaoPagamentoUseCase } from "./OperacaoDevolucaoPagamentoUseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class OperacaoCancelaPgtoAgendadoController {

    constructor(private SolicitacaoUseCase: OperacaoDevolucaoPagamentoUseCase) { };
