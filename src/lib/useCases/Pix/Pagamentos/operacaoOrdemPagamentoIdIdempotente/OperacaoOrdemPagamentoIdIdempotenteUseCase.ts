...
import { OperacaoOrdemPagamentoIdIdempotenteDTO } from './OperacaoOrdemPagamentoIdIdempotenteDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class OperacaoOrdemPagamentoIdIdempotenteUseCase {
    ...
    async run(Data: OperacaoOrdemPagamentoIdIdempotenteDTO) {
        const axios = require('axios');

        let config = {
            method: 'get',
            maxBodyLength: Infinity,
            url: 'https://gaph.bancoarbi.com.br/pix/v2/operacao/ordem_pagamento/id_idempotente/{idIdempotente}',
            headers: {
