...
import { OperacaoValorPagamentosDTO } from './OperacaoValorPagamentosDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class OperacaoValorPagamentosUseCase {
    ...
    async run(Data: OperacaoValorPagamentosDTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/operacao/valor_pagamentos',
            headers: {
