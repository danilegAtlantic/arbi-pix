...
import { OperacaoListaPgtosAgendadosDTO } from './OperacaoListaPgtosAgendadosDTO';
...
export class OperacaoGetPagamentoAgendadoUseCase {
    ...
    async run(Data: OperacaoListaPgtosAgendadosDTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/operacao/lista_pgtos_agendados',
            headers: {
