...
import OperacaoListaPgtosAgendadosValidationRules from './OperacaoListaPgtosAgendadosValidationRules.json';
import {OperacaoGetPagamentoAgendadoUseCase } from "./OperacaoListaPgtosAgendadosUseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class OperacaoGetPagamentoAgendadoController {

    constructor(private SolicitacaoUseCase: OperacaoGetPagamentoAgendadoUseCase) { };
