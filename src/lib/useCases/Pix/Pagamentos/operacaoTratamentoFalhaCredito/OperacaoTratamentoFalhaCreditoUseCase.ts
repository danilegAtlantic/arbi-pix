...
import { OperacaoTratamentoFalhaCreditoDTO } from './OperacaoTratamentoFalhaCreditoDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class OperacaoTratamentoFalhaCreditoUseCase {
    ...
    async run(Data: OperacaoTratamentoFalhaCreditoDTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/operacao/tratamento/falha_credito',
            headers: {
