...
import { OperacaoExtratoCompletoPixDTO } from './OperacaoExtratoCompletoPixDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class OperacaoExtratoCompletoPixUseCase {
    ...
    async run(Data: OperacaoExtratoCompletoPixDTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/operacao/extrato_completo_pix',
            headers: {
