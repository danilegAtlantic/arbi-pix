...
import { OperacaoTratamentoFalhaDebitoCancelamentoDTO } from './OperacaoTratamentoFalhaDebitoCancelamentoDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class OperacaoTratamentoFalhaDebitoCancelamentoUseCase {
    ...
    async run(Data: OperacaoTratamentoFalhaDebitoCancelamentoDTO) {
...
let config = {
  ...
  url: 'https://gaph.bancoarbi.com.br/pix/v2/operacao/tratamento/falha_debito/cancelamento',
  headers: { 
