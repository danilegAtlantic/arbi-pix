...
import { OperacaoTratamentoBaixaFalhaDebitoDTO } from './OperacaoTratamentoBaixaFalhaDebitoDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class OperacaoTratamentoBaixaFalhaDebitoUseCase {
    ...
    async run(Data: OperacaoTratamentoBaixaFalhaDebitoDTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/operacao/tratamento/baixa/falha_debito',
            headers: {
