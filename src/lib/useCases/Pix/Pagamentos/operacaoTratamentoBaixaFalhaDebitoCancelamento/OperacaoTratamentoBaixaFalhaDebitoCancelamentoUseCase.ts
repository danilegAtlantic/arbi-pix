...
import { OperacaoTratamentoBaixaFalhaDebitoCancelamentoDTO } from './OperacaoTratamentoBaixaFalhaDebitoCancelamentoDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class OperacaoTratamentoBaixaFalhaDebitoCancelamentoUseCase {
    ...
    async run(Data: OperacaoTratamentoBaixaFalhaDebitoCancelamentoDTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/operacao/tratamento/baixa/falha_debito/cancelamento',
            headers: {
