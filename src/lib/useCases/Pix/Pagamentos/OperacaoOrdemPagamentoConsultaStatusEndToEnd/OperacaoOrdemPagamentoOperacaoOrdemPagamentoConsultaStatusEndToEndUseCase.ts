...
import { OperacaoOrdemPagamentoConsultaStatusEndToEndDTO } from './OperacaoOrdemPagamentoOperacaoOrdemPagamentoConsultaStatusEndToEndDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class OperacaoOrdemPagamentoConsultaStatusEndToEndUseCase {
    ...
    async run(Data: OperacaoOrdemPagamentoConsultaStatusEndToEndDTO) {
        const axios = require('axios');

        let config = {
            method: 'get',
            maxBodyLength: Infinity,
            url: 'https://gaph.bancoarbi.com.br/pix/v2/operacao/ordem_pagamento/consulta_status/{endToEnd}',
            headers: {
