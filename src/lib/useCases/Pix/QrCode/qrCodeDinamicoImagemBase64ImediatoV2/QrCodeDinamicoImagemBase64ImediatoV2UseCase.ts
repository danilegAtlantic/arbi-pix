...
import { QrCodeDinamicoImagemBase64DTO } from './QrCodeDinamicoImagemBase64ImediatoV2DTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class QrCodeDinamicoImagemBase64UseCase {
    ...
    async run(Data: QrCodeDinamicoImagemBase64DTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/qrcode/dinamico/imagem_base_64/imediato/v2',
            headers: {
