...
import SolicitacaoValidationRules from './QrCodeProcessamentoBase64ValidationRules.json';
import { QrCodeProcessamentoBase64UseCase } from "./QrCodeProcessamentoBase64UseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class QrCodeProcessamentoBase64Controller {

    constructor(private SolicitacaoUseCase: QrCodeProcessamentoBase64UseCase) { };
