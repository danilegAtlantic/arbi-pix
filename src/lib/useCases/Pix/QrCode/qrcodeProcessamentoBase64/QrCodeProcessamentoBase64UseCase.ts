...
import { QrCodeProcessamentoBase64DTO } from './QrCodeProcessamentoBase64DTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class QrCodeProcessamentoBase64UseCase {
    ...
    async run(Data: QrCodeProcessamentoBase64DTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/qrcode/processamento/base_64',
            headers: {
