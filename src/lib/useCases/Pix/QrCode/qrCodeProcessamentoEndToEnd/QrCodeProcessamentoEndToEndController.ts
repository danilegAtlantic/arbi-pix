...
import SolicitacaoValidationRules from './QrCodeProcessamentoEndToEndValidationRules.json';
import { QrCodeProcessamentoEndToEndUseCase } from "./QrCodeProcessamentoEndToEndUseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class QrCodeProcessamentoEndToEndController {

    constructor(private SolicitacaoUseCase: QrCodeProcessamentoEndToEndUseCase) { };
