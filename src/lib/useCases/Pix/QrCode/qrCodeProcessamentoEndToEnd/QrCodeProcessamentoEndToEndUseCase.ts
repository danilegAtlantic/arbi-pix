...
import { QrCodeProcessamentoEndToEndDTO } from './QrCodeProcessamentoEndToEndDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class QrCodeProcessamentoEndToEndUseCase {
    ...
    async run(Data: QrCodeProcessamentoEndToEndDTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/qrcode/processamento/end_to_end',
            headers: {
