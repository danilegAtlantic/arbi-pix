...
import SolicitacaoValidationRules from './QrCodeDConsultaQrCodeDinamicoValidationRules.json';
import { QrCodeDConsultaQrCodeDinamicoUseCase } from "./QrCodeDConsultaQrCodeDinamicoUseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class QrCodeDinamicoVencimentoAlterarController {

    constructor(private SolicitacaoUseCase: QrCodeDConsultaQrCodeDinamicoUseCase) { };
