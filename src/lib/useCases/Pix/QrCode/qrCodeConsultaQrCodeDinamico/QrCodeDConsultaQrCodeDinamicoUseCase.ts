...
import { QrCodeDConsultaQrCodeDinamicoDTO } from './QrCodeDConsultaQrCodeDinamicoDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class QrCodeDConsultaQrCodeDinamicoUseCase {
    ...
    async run(Data: QrCodeDConsultaQrCodeDinamicoDTO) {
