...
import { QrCodeProcessamentoDTO } from './QrCodeProcessamentoDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class QrCodeProcessamentoUseCase {
    ...
    async run(Data: QrCodeProcessamentoDTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/qrcode/processamento',
            headers: {
