...
import { QrCodeEstaticoImagemBase64DTO } from './QrCodeEstaticoImagemBase64DTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class QrCodeEstaticoImagemBase64UseCase {
    ...
    async run(Data: QrCodeEstaticoImagemBase64DTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/qrcode/estatico/imagem_base_64',
            headers: {
