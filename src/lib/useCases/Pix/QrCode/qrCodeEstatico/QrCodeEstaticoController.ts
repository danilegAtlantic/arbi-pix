...
import SolicitacaoValidationRules from './QrCodeEstaticoValidationRules.json';
import { QrCodeEstaticoUseCase } from "./QrCodeEstaticoUseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class QrCodeEstaticoController {

    constructor(private SolicitacaoUseCase: QrCodeEstaticoUseCase) { };
