...
import { QrCodeEstaticoBase64UrlBaseDTO } from './QrCodeEstaticoBase64UrlBaseDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class QrCodeEstaticoBase64UrlBaseUseCase {
    ...
    async run(Data: QrCodeEstaticoBase64UrlBaseDTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/qrcode/estatico/base_64/url_base',
            headers: {
