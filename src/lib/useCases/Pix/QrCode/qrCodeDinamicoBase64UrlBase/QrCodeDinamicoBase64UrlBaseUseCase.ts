...
import { QrCodeDinamicoBase64UrlBaseDTO } from './QrCodeDinamicoBase64UrlBaseDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class QrCodeDinamicoBase64UrlBaseUseCase {
    ...
    async run(Data: QrCodeDinamicoBase64UrlBaseDTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/qrcode/dinamico/base_64/url_base',
            headers: {
