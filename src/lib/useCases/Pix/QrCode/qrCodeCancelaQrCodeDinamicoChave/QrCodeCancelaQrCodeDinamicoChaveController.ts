...
import SolicitacaoValidationRules from './qrCodeConsultaCertqrcValidationRules.json';
import { QrCodeCancelaQrCodeDinamicoChaveUseCase } from "./QrCodeCancelaQrCodeDinamicoChaveUseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class QrCodeCancelaQrCodeDinamicoChaveAlterarController {

    constructor(private SolicitacaoUseCase: QrCodeCancelaQrCodeDinamicoChaveUseCase) { };
