...
import { qrCodeConsultaQrCodeDinamicoTxIdDTO } from './qrCodeConsultaQrCodeDinamicoTxIdDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class qrCodeConsultaQrCodeDinamicoTxIdUseCase {
    ...
    async run(Data: qrCodeConsultaQrCodeDinamicoTxIdDTO) {
