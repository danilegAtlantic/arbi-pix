...
import SolicitacaoValidationRules from './qrCodeConsultaQrCodeDinamicoTxIdValidationRules.json';
import { qrCodeConsultaQrCodeDinamicoTxIdUseCase } from "./qrCodeConsultaQrCodeDinamicoTxIdUseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class qrCodeConsultaQrCodeDinamicoTxIdController {

    constructor(private SolicitacaoUseCase: qrCodeConsultaQrCodeDinamicoTxIdUseCase) { };
