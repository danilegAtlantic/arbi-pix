...
import { qrCodeDinamicoExcluirUrlAcessTokenDTO } from './qrCodeDinamicoExcluirUrlAcessTokenDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class qrCodeDinamicoExcluirUrlAcessTokenUseCase {
    ...
    async run(Data: qrCodeDinamicoExcluirUrlAcessTokenDTO) {
        const axios = require('axios');

        let config = {
            method: 'delete',
            maxBodyLength: Infinity,
            url: 'https://gaph.bancoarbi.com.br/pix/v2/qrcode/dinamico/excluir/{urlAcessToken}',
            headers: {
