...
import { QrCodeDinamicoExcluirDTO } from './QrCodeDinamicoExcluirDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class QrCodeDinamicoExcluirUseCase {
    ...
    async run(Data: QrCodeDinamicoExcluirDTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/qrcode/dinamico/excluir',
            headers: {
