...
import { QrCodeDinamicoImagemBase64VencimentoV2DTO } from './QrCodeDinamicoImagemBase64VencimentoV2DTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class QrCodeDinamicoImagemBase64VencimentoV2UseCase {
    ...
    async run(Data: QrCodeDinamicoImagemBase64VencimentoV2DTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/qrcode/dinamico/imagem_base_64/vencimento/v2',
            headers: {
