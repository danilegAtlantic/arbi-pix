...
import SolicitacaoValidationRules from './QrCodeDinamicoImediatoV2ValidationRules.json';
import { QrCodeDinamicoImediatoV2UseCase } from "./QrCodeDinamicoImediatoV2UseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class QrCodeDinamicoImediatoV2Controller {

    constructor(private SolicitacaoUseCase: QrCodeDinamicoImediatoV2UseCase) { };
