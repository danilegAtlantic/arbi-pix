...
import { QrCodeDinamicoImediatoV2DTO } from './QrCodeDinamicoImediatoV2DTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class QrCodeDinamicoImediatoV2UseCase {
    ...
    async run(Data: QrCodeDinamicoImediatoV2DTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/qrcode/dinamico/imediato/v2',
            headers: {
