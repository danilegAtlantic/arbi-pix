...
import { QrCodeProcessamentoBase64EndToEndDTO } from './QrCodeProcessamentoBase64EndToEndDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class QrCodeProcessamentoBase64EndToEndUseCase {
    ...
    async run(Data: QrCodeProcessamentoBase64EndToEndDTO) {
        const axios = require('axios');
        let data = JSON.stringify({
            "qrCodeValue": Data.qrCodeValue,
            "cpfCnpj": Data.cpfCnpj,
            "endToEnd": Data.endToEnd,
            "indConsultaDICT": Data.indConsultaDICT
        });

        let config = {
            method: 'post',
            maxBodyLength: Infinity,
            url: 'https://gaph.bancoarbi.com.br/pix/v2/qrcode/processamento/base_64/end_to_end',
            headers: {
