...
import SolicitacaoValidationRules from './QrCodeConsultaEndToEndValidationRules.json';
import { QrCodeConsultaEndToEndUseCase } from "./QrCodeConsultaEndToEndUseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class QrCodeDinamicoVencimentoAlterarController {

    constructor(private SolicitacaoUseCase: QrCodeConsultaEndToEndUseCase) { };
