...
import SolicitacaoValidationRules from './QrCodeEstaticoBase64ValidationRules.json';
import { QrCodeEstaticoBase64UseCase } from "./QrCodeEstaticoBase64UseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class QrCodeEstaticoController {

    constructor(private SolicitacaoUseCase: QrCodeEstaticoBase64UseCase) { };
