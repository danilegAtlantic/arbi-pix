...
import { QrCodeEstaticoBase64DTO } from './QrCodeEstaticoBase64DTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class QrCodeEstaticoBase64UseCase {
    ...
    async run(Data: QrCodeEstaticoBase64DTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/qrcode/estatico/base_64',
            headers: {
