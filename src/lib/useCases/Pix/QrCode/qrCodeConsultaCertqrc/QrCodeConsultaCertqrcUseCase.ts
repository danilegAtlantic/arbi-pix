...
import { qrCodeConsultaCertqrcDTO } from './QrCodeConsultaCertqrcDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class qrCodeConsultaCertqrcUseCase {
    ...
    async run(Data: qrCodeConsultaCertqrcDTO) {
        const axios = require('axios');

        let config = {
            method: 'get',
            maxBodyLength: Infinity,
            url: 'https://gaph.bancoarbi.com.br/pix/v2/qrcode/consulta/certqrc',
            headers: {
