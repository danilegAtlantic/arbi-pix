...
import { QrCodeDinamicoBase64UrlBaseImediatoDTO } from './QrCodeDinamicoBase64UrlBaseImediatoDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class QrCodeDinamicoBase64UrlBaseImediatoUseCase {
    ...
    async run(Data: QrCodeDinamicoBase64UrlBaseImediatoDTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/qrcode/dinamico/base_64/url_base/imediato/v2',
            headers: {
