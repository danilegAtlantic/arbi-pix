...
import { QrCodeDinamicoDTO } from './QrCodeDinamicoDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class QrCodeDinamicoUseCase {
    ...
    async run(Data: QrCodeDinamicoDTO) {
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/qrcode/dinamico',
            headers: {
