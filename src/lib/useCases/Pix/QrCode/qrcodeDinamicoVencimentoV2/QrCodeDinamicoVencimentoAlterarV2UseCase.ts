...
import { QrCodeDinamicoVencimentoAlterarV2DTO } from './QrCodeDinamicoVencimentoV2AlterarDTO';
import { logError, tint } from '../../../../../bin/functions/CursorLog';

export class QrCodeDinamicoVencimentoAlterarV2UseCase {
    ...
    async run(Data: QrCodeDinamicoVencimentoAlterarV2DTO) {
        ...
        let data = JSON.stringify({
            ...
            "modalidadeMulta":Data.modalidadeAbatimento,
            ...
            "descontosDataFixa": [
                {
                    ...
                    "valorPerc": Data.descontosDataFixa[0].valorPerc
                }
            ]
        });
        ...
        let config = {
            ...
            url: 'https://gaph.bancoarbi.com.br/pix/v2/qrcode/dinamico/vencimento/v2',
            headers: {
