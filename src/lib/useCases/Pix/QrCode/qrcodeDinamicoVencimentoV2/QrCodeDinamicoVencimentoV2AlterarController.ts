...
import SolicitacaoValidationRules from './QrCodeDinamicoVencimentoAlterarV2ValidationRules.json';
import { QrCodeDinamicoVencimentoAlterarV2UseCase } from "./QrCodeDinamicoVencimentoAlterarV2UseCase";
import { logError, tint } from "../../../../../bin/functions/CursorLog";

export class QrCodeDinamicoVencimentoV2AlterarController {

    constructor(private SolicitacaoUseCase: QrCodeDinamicoVencimentoAlterarV2UseCase) { };
